...
export function buildPrompt({
  ...
  const playerBlock = trimmedName
    ? `You know the player's name is ${trimmedName}. This is just context — use it only if it genuinely feels natural, the way a friend would, not as a habit at the start of every reply.\n\n`
    : "";
