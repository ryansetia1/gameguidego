...
${playerBlock}${memoryBlock}${conversationBlock}${spoilerBlock}${preferredDirective}${webSupplementDirective}${firstTurnBlock}Web research (supporting evidence, may be incomplete or irrelevant):
${research}
