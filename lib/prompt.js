...
export function buildPrompt({
  ...
  const playerBlock = trimmedName
    ? conversation
      ? `Player display name: ${trimmedName}\nThis is a follow-up in an ongoing chat. Do NOT greet the player, say "hello again", or use other salutations — continue directly with the answer.\n\n`
      : `Player display name: ${trimmedName}\nYou may use this name once in your opening if it feels natural. Do not greet again on later turns.\n\n`
    : "";

  return `Game: ${game || "unspecified"}
Platform: ${platform || "unspecified"}

${playerBlock}${conversationBlock}${spoilerBlock}Web research (supporting evidence, may be incomplete or irrelevant):
${research}
