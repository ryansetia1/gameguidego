...
export function buildPrompt({
  ...
  const imageBlock =
    imageCount > 0
      ? `The player attached ${imageCount} image(s) with this question (e.g. a screenshot or photo of where they are stuck). Use them as visual context — identify the exact screen, location, item, enemy, or menu shown, and read any dialog or text present. ${IMAGE_CHARACTER_RULES} ${IMAGE_PRIOR_ID_WARNING} Prioritise what they depict over guesses.\n\n`
      : "";
