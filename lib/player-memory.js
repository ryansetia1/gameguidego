...
// Single source of truth in lib/game-room.js so memory keys and chat-room keys can
// never drift apart (they were two identical copies before). Re-export keeps every
// existing `from "./player-memory.js"` import working.
export { normGameKey, legacyNormGameKey } from "./game-room.js";
