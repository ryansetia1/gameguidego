...
const POSITION_FOLLOWUP =
  /\b(?:after|setelah|once|already|udah)\b.+\b(?:elevator|stairs|staircase|basement|room|door|boss|tangga|elevator)\b/i;
 ...
 * @param {string[]} landmarks
 * @returns {{ rows: typeof rows, parent: typeof rows[number] | null, marked: boolean }}
 */
